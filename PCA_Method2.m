%--------------------------------Method 2--------------------------------%
%Use the first twenty five subjects (1.pgm to 10.pgm) for training the 
%subspace. Use the rest 15 subjects for the performance evaluation. 
...
testing = testing-repmat(mean(testing,2),1,150);
